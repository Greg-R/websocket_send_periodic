...
const struct mgos_conf_entry sys_config_schema_[90] = {
  {.type = CONF_TYPE_OBJECT, .key = "", .num_desc = 89},
  ...
  {.type = CONF_TYPE_STRING, .key = "tz_spec", .offset = offsetof(struct sys_config, sys.tz_spec)},
